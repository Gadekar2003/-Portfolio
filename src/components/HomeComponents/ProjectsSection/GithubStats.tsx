...
const GithubStats = () => {
  ...
  const _primary =
    theme === "dark"
      ? // @ts-ignore
        config.theme?.semanticTokens?.colors?.primary.value._dark
      : // @ts-ignore
        config.theme?.semanticTokens?.colors?.primary.value.base;
  const _accent =
    theme === "dark"
      ? // @ts-ignore
        config.theme?.semanticTokens?.colors?.accent.value._dark
      : // @ts-ignore
        config.theme?.semanticTokens?.colors?.accent.value.base;
